    ...
    return (
        ...
        <section className='flex items-center w-full justify-evenly h-full' id='home'>
            <div className='flex my-auto flex-col gap-5 text-white font-bold text-4xl'>
                ...
                <Link to='' className='mt-5 p-2 px-3 bg-lighter rounded-sm text-center text-sm hover:bg-light transition-all 150'>Contact me</Link>
            </div>
            <div className='h-1/2 w-1/5 flex flex-col-reverse justify-end items-end'>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" className="h-32 w-32 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
