            ...
            <CSSTransition in={test} timeout={200} classNames='slide' unmountOnExit={true}>
                <section id='about' className='w-full h-screen bg-primary flex'>
                    <div className='h-full w-4/5 mx-auto md:mx-0 md:w-full flex justify-center items-center md:pr-0'>
                        <div className='font-bold text-white p-2 flex flex-col gap-5 md:pl-20 w-2/3 items-start justify-center'>
                            <h1 className='md:text-4xl text-2xl text-tertiary'>About me</h1>
                                <ul className='flex list-disc md:hidden text-xs flex-col gap-5'>
